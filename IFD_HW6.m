function [ optionPrices, St, middle] = IFD_HW6( type, kind, S0, K, r, sigma, T, delta_x, delta_t, Smax, Smin )
%Funtion to valuate an option using Implicit Finite Difference Method.
%INPUT
