function price = EuroExchageOptions( S1, S2, sigma1, sigma2, D1, D2, T, r, rho) % European exchange options Margrabe model %  price = margrabeEuroExchageOptions(  S1, S2, sigma1, sigma2, D1, D2, T, r, rho) % % Input Parameters:
% ================
